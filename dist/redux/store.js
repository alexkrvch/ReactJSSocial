...
var messagesReducer_1 = __importDefault(require("./messagesReducer"));
var store = {
    _state: {
        ProfilePage: {
            PostData: [
    ...
    dispatch: function (action) {
        this._state.ProfilePage = profileReducer_1.default(this._state.ProfilePage, action);
        this._state.MessagesPage = messagesReducer_1.default(this._state.MessagesPage, action);
